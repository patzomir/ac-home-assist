...
2. **Бекенд** — изчислява консумацията по модел (режим + зададена температура + външна температура от weather API)
...
|---|---|---|---|---|
| 1 AC | ~35 BGN | ~70 BGN | ~115 BGN | <1 сезон |
| 2 AC | ~45 BGN | ~90 BGN | ~230 BGN | <1 сезон |
| 3 AC | ~55 BGN | ~110 BGN | ~345 BGN | <1 сезон |

Хъбът е споделен — всеки допълнителен климатик добавя само ~10 BGN hardware при спестявания от ~115 BGN/сезон.
